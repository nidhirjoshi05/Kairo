        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            <img 
              src={kairoLogo} 
              alt="Kairo" 
              className="w-80 h-80 mx-auto mb-1 drop-shadow-2xl"
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <div className="flex items-center gap-3 mb-8 justify-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold" data-testid="text-about-title">Kairo</h2>
            </div>
            <div className="space-y-5 text-base md:text-lg text-muted-foreground leading-relaxed text-center max-w-4xl mx-auto">
              <p className="text-justify text-lg">
              Kairo comes from Kairos- the ancient Greek word for “the right moment.” It represents that pause between feeling and understanding, where real growth begins. Kairo exists to help people find that pause- to reflect, heal, and transform. In a world that moves too fast for emotions, it offers a space to slow down. By combining Artificial Intelligence, Emotional Intelligence, and Human Connection, Kairo helps individuals understand their emotions, strengthen resilience, and build meaningful relationships. It isn’t just another therapy app- it’s an emotional ecosystem. Through AI-driven reflection, mood tracking, real mentors, and Healing Circles, Kairo empowers people to grow emotionally, one insight at a time. Because emotional well-being isn’t a luxury- it’s a lifelong skill.
              </p>
            </div>
          </motion.div>
